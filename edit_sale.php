    ...
    validate_fields($req_fields);
        if(empty($errors)){
          ...
          if( $result && $db->affected_rows() === 1){
                    ...
                    $session->msg('s',"Prestamo Actualizado.");
                    redirect('edit_sale.php?id='.$sale['id'], false);
                  } else {
                    $session->msg('d',' No se ha actualizado ningun campo!');
  ...
  <div class="panel">
    <div class="panel-heading clearfix">
      <strong>
        ...
        <span>Modificar Prestamo</span>
     </strong>
     <div class="pull-right">
       <a href="sales.php" class="btn btn-primary">Mostrar todos los prestamos</a>
     </div>
    </div>
